...
for applicable_tournament_url in applicable_tournament_urls:
    ...
    for event_team_container in event_teams_containers:
        ...
        if event_team_name == "100 Thieves":
            players = ["Asuna", "bang", "vora", "Cryocells", "Timotino"]
        elif event_team_name == "Cloud9": 
            players = ["Zellsis", "penny", "Xeppaa", "v1c", "OXY"]
        elif event_team_name == "Evil Geniuses":
            players = ["supamen", "C0M", "bao", "Okeanos", "dgzin"]
        elif event_team_name == "FURIA":
            players = ["nerve", "artzin", "eeiu", "koalanoob", "alym"]
        elif event_team_name == "KRÜ Esports":
            players = ["saadhak", "mwzera", "silentzz", "Less", "Dantedeu5"]
        elif event_team_name == "LEVIATÁN":
            players = ["spike", "blowz", "Neon", "kiNgg", "Sato"]
        elif event_team_name == "LOUD":
            players = ["lukxo", "Darker", "Virtyy", "pANcada", "cauanzin"]
        elif event_team_name == "MIBR":
            players = ["zekken", "tex", "Mazino", "aspas", "Verno"]
        elif event_team_name == "NRG":
            players = ["brawk", "keiko", "mada", "skuba", "Ethan"]
        elif event_team_name == "Sentinels":
            players = ["Reduxx", "johnqt", "Kyu", "cortezia", "N4RRATE"]
        elif event_team_name == "G2 Esports":
            players = ["valyn", "jawgemo", "BABYBAY", "leaf", "trent"]
        elif event_team_name == "ENVY":
            players = ["POPPIN", "Eggsterr", "Inspire", "keznit", "Rossy"]   
        else:
